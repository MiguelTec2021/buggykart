...
String serve = 'http://192.168.8.102/api';
...
class _RegisterUserPageState extends State<RegisterUserPage> {
  ...
  Future<void> subirimagen() async {
    try {
      ...
      var response = await dio.post('${serve1}addPhoto.php', data: formData);
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  const Text(
                    'Crear cuenta',
                    style: TextStyle(fontFamily: 'museoBold', fontSize: 30.0),
                  ),
                  const SizedBox(
                    height: 10.0,
                  ),
                      ...
                      onPressed: () {
                        ...
                        if (name != '' &&
                          ...
                          if (isEmail(email) == false) {
                            ...
                            registrarUsuario(context, name, foto, lasname,
                                years, user, email, password);
                            subirimagen();
                          }
                          // print(foto.toString());
                        } else {
